...
#    Updated: 2022/10/26 15:08:53 by frcarval         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES		=	so_long.c						\
				...
				funcs/map_related/map_cp.c		\
				funcs/map_related/verif.c		\
				funcs/mlx_related/window.c		\
				funcs/mlx_related/general.c		\
...
NAME 	=	so_long
GCCW	=	@gcc -g -Wall -Wextra -Werror -I/usr/local/include -I./

all:		$(NAME)

$(NAME): 	$(SOURCES)
			$(GCCW) $^ -o $@ -fsanitize=address -L/usr/local/lib -lmlx -framework OpenGL -framework AppKit
